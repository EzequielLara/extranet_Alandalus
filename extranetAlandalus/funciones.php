...
function mostrarMensajeOK($msg, $usuario, $perfil) {
    ...
    if($msg>0&&$msg<10) {
        $mensaje[1]="Bienvenid@ $usuario, ha accedido a la extranet del <span style='color: blue;'>IES AL-ANDALUS</span> con el perfíl de <span style='color: blue;'>$perfil </span>*";

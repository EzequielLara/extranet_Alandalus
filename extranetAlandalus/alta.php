...
$altaAlumno = "INSERT INTO ies_alumno VALUES ($proximo, concat(concat('@','$nombre'),$proximo), '12345678', '$nombre', '$apellidos', $telefono, '$email', $curso, 1)";

}else{

    echo '<div class="mx-auto" style="width: 35rem;">
        <div class="card-body">
        <h5 class="card-header text-center">No tiene acceso a este contenido</h5>
        </div>
        </div>';
};
